...
1. [Pre-Mac Era (1980-1984)](#pre-mac-era-1980-1984) - Birth of the GUI
2. [Classic Macintosh (1985-1992)](#classic-macintosh-era-1985-1992) - Defining the Desktop
3. [NeXT & Newton (1993-1996)](#next--newton-era-1993-1996) - Object-Oriented and Mobile
4. [Mac OS 8/9 (1997-1999)](#mac-os-89-era-1997-1999) - Platinum Transition
5. [Aqua Era (2000-2007)](#aqua-era-2000-2007) - OS X Revolution
6. [iPhone & iOS (2008-2014)](#iphone--ios-era-2008-2014) - Touch Transform
7. [Modern OS X (2012-2014)](#modern-os-x-2012-2014) - Convergence
...
**Platform**: Lisa, Apple II
**Input**: Mouse (Lisa), Keyboard (Apple II)
**Visual**: Monochrome (Lisa), 6-color (Apple II)
**Storage**: 5MB Profile HD (Lisa), Floppy (Apple II)

**Legacy**:
Everything modern UI comes from here:
...
**Impact**:
Every Mac app from 1986 onwards followed these rules, creating remarkable consistency.
...
This is THE definitive Classic Mac HIG.
...
**Why It Matters**:
This document defined desktop computing. Windows, GNOME, KDE all borrowed from these principles.
...
**Why Important**:
Last major revision before OS X. Captures mature Classic Mac OS design.

---

### Era Summary

**Platforms**: Macintosh, Apple II
**OS Versions**: System 4-7
**Displays**: 512x342 B&W → 640x480+ Color
**Input**: Mouse + Keyboard
**Storage**: 800KB Floppy → Hard drives
...
**Influence**:
Every modern desktop OS (Windows, Linux, ChromeOS) uses these patterns.
...
**Why NeXT Matters**:
When Steve Jobs returned to Apple (1997), NeXTSTEP became the foundation of Mac OS X. Many patterns from this document appeared in Aqua (2001).
...
**Why Newton Succeeded**:
iPhone (2007) borrowed heavily:
...
**Legacy**:
Newton was 10 years too early. Every concept here reappeared in iOS.

---

### Era Summary

**Platforms**: NeXTSTEP, Newton, Mac
**Key Themes**: Object-oriented UI, mobile computing, touch
**Failed Commercially**: NeXT sold to Apple, Newton cancelled
**Succeeded Historically**: All ideas reused later
...
**Why It Matters**:
Last major HIG before OS X. Represents the culmination of 13 years of Classic Mac OS refinement (1984-1997).
...
**Platform**: Mac OS 8/9
**Period**: 1997-2001 (transitional)
**Theme**: Refinement before revolution

**Status**: Mature but aging
Apple knew radical change was needed. NeXTSTEP acquisition (1997) planted the seeds for Mac OS X.
...
**Purpose**:
Help developers migrate apps from Platinum (Mac OS 9) to Aqua (Mac OS X).
...
**Sheets**:
Revolutionary modal dialog pattern:
...
**Brushed Metal**:
Controversial "pro app" appearance:
...
**Platform**: Mac OS X (10.0-10.6)
**Years**: 2000-2009
**Design Language**: Aqua
**Theme**: Beauty, depth, delight
...
**Legacy**:
Aqua proved beautiful UI could be functional. Influenced all modern operating systems to prioritize visual polish.
...
Content responds to touch directly:
...
**Why It Mattered**:
Established mobile UI patterns still used today across iOS and Android.
...
**Why It Matters**:
Shows Apple's original vision: web as the platform. Native apps won due to performance and capabilities.
...
**OS Versions**: iOS 2-8
**Years**: 2008-2014
**Revolution**: Touch-first computing
...
**Legacy**:
Every mobile OS (Android, Windows Phone, WebOS) adopted these patterns. Touch computing became the dominant paradigm.
...
**Platform**: Mac OS X (10.8-10.10)
**Years**: 2012-2014
**Theme**: Convergence with iOS
...
**End of an Era**:
These guidelines close out our 1980-2014 archive. Modern HIG continues at apple.com.
...
**1980**: Text-based computing dominates
**1984**: GUI becomes accessible (Mac)
**1993**: Object-oriented UI thinking (NeXT)
**1996**: Touch and mobile attempted (Newton)
**2001**: Beauty and polish standard (Aqua)
**2008**: Touch computing succeeds (iPhone)
**2013**: Flat design wins (iOS 7)
...
- [Current Apple HIG](https://developer.apple.com/design/human-interface-guidelines/)
